...
bool FModManager::create_sound(const std::string& Sound_name, const cXML::MyMusic path, const int mode, const bool iscompress)
{
	FMOD::Sound* sound;
	int option = mode;
	std::string sel_path;
...
bool FModManager::create_stream(const std::string& stream_name, const cXML::MyMusic path , const int mode, const bool is_compress)
{
	FMOD::Sound* sound;
	int option = mode;
	std::string sel_path;
